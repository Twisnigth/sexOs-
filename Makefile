...
$(OBJDIR)/settings.elf: $(OBJDIR)/u_settings.o $(APPLIBS) user/user.ld
	$(LD) $(ULDFLAGS) -o $@ $(OBJDIR)/u_settings.o $(APPLIBS)
$(OBJDIR)/calc.elf: $(OBJDIR)/u_calc.o $(APPLIBS) user/user.ld
...
$(OBJDIR)/imgview.elf: $(OBJDIR)/u_imgview.o $(OBJDIR)/u_imgdec.o $(APPLIBS) user/user.ld
...
WEB_OBJS := $(OBJDIR)/u_web.o $(OBJDIR)/u_html.o $(OBJDIR)/u_http.o $(OBJDIR)/u_tls.o \
